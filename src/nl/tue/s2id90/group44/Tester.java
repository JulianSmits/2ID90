...
public class Tester extends DraughtsPlayer {
    ...
    public Tester(int maxSearchDepth) {
        super("best.png");
    ...
    int evaluate(DraughtsState state) {
        ...
        result += (1 * materialDiff + 0 * positionDiff + 0 * balanceDiff + 0 * diagonalDiff + 0 * position + 0 * balance + 0 * material + 0 * diagonal);
